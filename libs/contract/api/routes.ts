...
export const REST_API = {
    AUDIT_LOGS: {
        GET: `${ROOT}/${CONTROLLERS.AUDIT_LOGS_CONTROLLER}/${CONTROLLERS.AUDIT_LOGS_ROUTES.GET}`,
        GET_BY_ID: (id: string) =>
            `${ROOT}/${CONTROLLERS.AUDIT_LOGS_CONTROLLER}/${CONTROLLERS.AUDIT_LOGS_ROUTES.GET_BY_ID(id)}`,
        DELETE: (id: string) =>
            `${ROOT}/${CONTROLLERS.AUDIT_LOGS_CONTROLLER}/${CONTROLLERS.AUDIT_LOGS_ROUTES.DELETE(id)}`,
    },
    EGRESS_RULES: {
        CREATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.CREATE}`,
        GET: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GET}`,
        GET_BY_UUID: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GET_BY_UUID(uuid)}`,
        UPDATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.UPDATE}`,
        DELETE: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.DELETE(uuid)}`,
        ACTIONS: {
            IMPORT_RULE_LIST: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.ACTIONS.IMPORT_RULE_LIST}`,
            REORDER: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.ACTIONS.REORDER}`,
        },
        TEST: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.TEST}`,
        OUTBOUNDS: {
            CREATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.OUTBOUNDS.CREATE}`,
            GET: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.OUTBOUNDS.GET}`,
            UPDATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.OUTBOUNDS.UPDATE}`,
            TEST: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.OUTBOUNDS.TEST}`,
            DELETE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.OUTBOUNDS.DELETE(uuid)}`,
        },
        GROUPS: {
            CREATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GROUPS.CREATE}`,
            GET: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GROUPS.GET}`,
            UPDATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GROUPS.UPDATE}`,
            DELETE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.GROUPS.DELETE(uuid)}`,
        },
        SUBSCRIPTIONS: {
            CREATE: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.SUBSCRIPTIONS.CREATE}`,
            GET: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.SUBSCRIPTIONS.GET}`,
            UPDATE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.SUBSCRIPTIONS.UPDATE(uuid)}`,
            SYNC: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.SUBSCRIPTIONS.SYNC(uuid)}`,
            DELETE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.SUBSCRIPTIONS.DELETE(uuid)}`,
        },
        CONFIG: {
            EXPORT: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.CONFIG.EXPORT}`,
            IMPORT: `${ROOT}/${CONTROLLERS.EGRESS_RULES_CONTROLLER}/${CONTROLLERS.EGRESS_RULES_ROUTES.CONFIG.IMPORT}`,
        },
    },
    PROXY_ACCESS_AUDIT: {
        INGEST: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.INGEST}`,
        LOGS: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.LOGS}`,
        SUMMARY: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.SUMMARY}`,
        TOP_DOMAINS: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.TOP_DOMAINS}`,
        RULE_HITS: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.RULE_HITS}`,
        ALERTS: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.ALERTS}`,
        SETTINGS: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.SETTINGS}`,
        CLEANUP: `${ROOT}/${CONTROLLERS.PROXY_ACCESS_AUDIT_CONTROLLER}/${CONTROLLERS.PROXY_ACCESS_AUDIT_ROUTES.CLEANUP}`,
    },
    AUTH: {
    ...
    SYSTEM: {
        ...
        DIAGNOSTICS: `${ROOT}/${CONTROLLERS.SYSTEM_CONTROLLER}/${CONTROLLERS.SYSTEM_ROUTES.DIAGNOSTICS}`,
        STATS: {
